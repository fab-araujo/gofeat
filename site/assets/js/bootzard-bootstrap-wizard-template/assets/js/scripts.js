...
jQuery(document).ready(function () {
    ...
    $('.f1 .btn-next').on('click', function () {
        ...
        if ($(this).hasClass('next-step-2')) {
            if ($('#file-select').val().length > 0 || $('#sequences').val() != "") {
                next_step = true;
            } else {
                next_step = false;
            }
            ...
            if (!next_step) {
                $('#file-label').addClass('input-error');
                $('#sequences').addClass('input-error');
                next_step = false;
            } else {
                $('#file-label').removeClass('input-error');
                $('#sequences').removeClass('input-error');
            }
        }
